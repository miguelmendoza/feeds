;(function( $ ) {
    ...
    function token() {
        ...
        $.ajax({
            type: 'GET',
            url: 'http://feeds-televisadeportes.dev/01_wdg_teams_classification_01/feedsjson/json01.js',
            // url: 'http://mxm.televisadeportes.esmas.com/futbol/data/'+objSettings.idTorneo+'/tablageneral.js',
            async: false,
    ...
    function successData( data ) {
        var html = createHTML( data , objSettings );
        $objGlobal.delay( 8000 ).html( html );
        $objGlobal.children('div').fadeIn( 2000 );
    }
